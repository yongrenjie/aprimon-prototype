...
ALL_POKEMON = {
    ...
    83: Pokemon("Farfetch'd", "farfetchd",
                ["farfetch'd-g", "farfetch'd-galar", "farfetch'd (galar)", "farfetch'd (kanto)"],
    ...
    113: Pokemon("Chansey", "chansey", [], 113, swsh=True, bdsp=False),
    ...
    122: Pokemon("Mr. Mime", "mr-mime",
                 ["mr. mime-g", "mr. mime-galar", "mr. mime (galar)", "mr. mime (kanto)"],
    ...
    143: Pokemon("Snorlax", "snorlax", [], 143, swsh=True, bdsp=False),
    ...
    172: Pokemon("Pichu", "pichu", [], 172, swsh=True, bdsp=False),
    173: Pokemon("Cleffa", "cleffa", [], 173, swsh=True, bdsp=False),
    174: Pokemon("Igglybuff", "igglybuff", [], 174, swsh=True, bdsp=False),
    175: Pokemon("Togepi", "togepi", [], 175, swsh=True, bdsp=False),
    177: Pokemon("Natu", "natu", [], 177, swsh=True, bdsp=False),
    183: Pokemon("Marill", "marill", [], 183, swsh=True, bdsp=False),
    185: Pokemon("Sudowoodo", "sudowoodo", [], 185, swsh=True, bdsp=False),
    194: Pokemon("Wooper", "wooper", [], 194, swsh=True, bdsp=False),
    202: Pokemon("Wobbuffet", "wobbuffet", [], 202, swsh=True, bdsp=False),
    ...
    226: Pokemon("Mantine", "mantine", [], 226, swsh=True, bdsp=False),
    227: Pokemon("Skarmory", "skarmory", [], 227, swsh=True, bdsp=False),
    236: Pokemon("Tyrogue", "tyrogue", [], 236, swsh=True, bdsp=False),
    238: Pokemon("Smoochum", "smoochum", [], 238, swsh=True, bdsp=False),
    239: Pokemon("Elekid", "elekid", [], 239, swsh=True, bdsp=False),
    240: Pokemon("Magby", "magby", [], 240, swsh=True, bdsp=False),
    ...
    263: Pokemon("Zigzagoon", "zigzagoon",
                 ["zigzagoon-g", "zigzagoon-galar", "zigzagoon (galar)", "zigzagoon (hoenn)"],
    ...
    422: Pokemon("Shellos", "shellos",
                 ["shellos-west", "shellos-west-sea", "shellos (west)", "shellos (west sea)", "shellos-east", "shellos-east-sea", "shellos (east)", "shellos (east sea)"],
    ...
    550: Pokemon("Basculin", "basculin",
                 ["basculin-blue", "basculin-blue-striped", "basculin (blue)", "basculin (blue striped)", "basculin-red", "basculin-red-striped", "basculin (red)", "basculin (red striped)"],
                 550, swsh=True, bdsp=False),
    551: Pokemon("Sandile", "sandile", [], 551, swsh=True, bdsp=False),
    554: Pokemon("Darumaka", "darumaka",
                 ["darumaka-g", "darumaka-galar", "darumaka (galar)", "darumaka (unova)"],
    ...
    562: Pokemon("Yamask", "yamask",
                 ["yamask-g", "yamask-galar", "yamask (galar)", "yamask (unova)"],
    ...
    618: Pokemon("Stunfisk", "stunfisk",
                 ["stunfisk-g", "stunfisk-galar", "stunfisk (galar)", "stunfisk (unova)"],
    ...
    744: Pokemon("Rockruff", "rockruff",
                 ["rockruff-dusk", "rockruff (dusk)", "rockruff (own tempo)", "own tempo rockruff", "rockruff-own tempo"],
